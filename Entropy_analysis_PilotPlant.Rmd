...
# save(Entropies.agg_grouped_corrected,file = "Entropies_grouped_corrected.RData")
 ...
 load("Entropies_grouped_sample.RData.RData")
...
if(pl > 1){
entropy <- entropyforboots.corrected(boots_f_recal,boots_p,weights = machine$weights,recal = T, con.mass.balance  = F,idx = idx)
}else{
entropy <- entropyforboots.corrected(boots_f,boots_p,weights = machine$weights, recal = F, con.mass.balance = F,idx = idx)
}
return(entropy)
}
